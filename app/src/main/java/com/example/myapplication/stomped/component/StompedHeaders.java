package com.example.myapplication.stomped.component;
...
public class StompedHeaders {
    ...
    public final static String STOMP_HEADER_SESSION_ID= "X-SESSION-ID";
    public final static String STOMP_HEADER_XSRF_TOCKEN= "X-XSRF-TOKEN";
    public final static String STOMP_HEADER_DOCUMENT_ID= "X-DOCUMENT-URI";
